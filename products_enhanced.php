                    ...
                    <div class="filter-card">
                        ...
                        <div class="filter-actions">
                            <?php if (!empty($category_id) || !empty($min_price) || !empty($max_price) || !empty($search) || $sort !== 'newest'): ?>
                                <a href="products_enhanced.php" class="btn btn-secondary btn-sm">Clear All Filters</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </aside>
                    ...
                    <div class="products-grid">
                        <?php if (empty($products)): ?>
                            <div class="no-products">
                                ...
                                <a href="products_enhanced.php" class="btn btn-primary btn-lg">Clear Filters</a>
                            </div>
                        <?php else: ?>
...
http://localhost/DivyaGhar/products_enhanced.php