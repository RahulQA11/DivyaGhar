...
footer .fa-visa, footer .fa-cc-mastercard, footer .fa-cc-paypal, footer .fa-google-pay, footer .fa-university {
    color: #fff !important;
    opacity: 0.8;
    transition: opacity 0.3s ease;
}

footer .fa-visa:hover, footer .fa-cc-mastercard:hover, footer .fa-cc-paypal:hover, footer .fa-google-pay:hover, footer .fa-university:hover {
    opacity: 1;
}
